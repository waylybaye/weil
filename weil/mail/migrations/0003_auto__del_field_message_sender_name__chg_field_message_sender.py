...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'mail_message', 'sender_name')


        # Changing field 'Message.sender'
        db.alter_column(u'mail_message', 'sender', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):
        # Adding field 'Message.sender_name'
        db.add_column(u'mail_message', 'sender_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Message.sender'
        db.alter_column(u'mail_message', 'sender', self.gf('django.db.models.fields.EmailField')(max_length=75))
